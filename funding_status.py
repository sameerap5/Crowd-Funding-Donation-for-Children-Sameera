...
import pandas as pd
#essay
essay = pd.read_csv('D:\\USF\Selenium\opendata_essays000.gz', escapechar='\\', names=['_projectid', '_teacherid', 'title', 'short_description', 'need_statement', 'essay', 'thankyou_note', 'impact_letter'])
...
newdata.to_csv('D:/USF/Selenium/funding_status.csv', sep='\t', encoding='utf-8' )