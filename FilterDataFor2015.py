...
giftcards_2015.to_csv(sys.argv[2])
...
don_projects_2015.to_csv(sys.argv[6]) 

# Filter resources data for 2015
resources = pd.read_csv(sys.argv[7], escapechar='\\', names=['_resourceid', '_projectid', 'vendorid', 'vendor_name', 'item_name', 'item_number', 'item_unit_price', 'item_quantity'])
...
essay_project.to_csv(sys.argv[8]) 
...
giving_project.to_csv(sys.argv[9]) 
